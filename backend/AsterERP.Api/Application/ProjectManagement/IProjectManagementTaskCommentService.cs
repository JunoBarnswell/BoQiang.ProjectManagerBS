...
public interface IProjectManagementTaskCommentService
{
    ...
    Task<GridPageResult<ProjectManagementTaskCommentResponse>> QueryAsync(string taskId, ProjectManagementTaskCommentQuery query, CancellationToken cancellationToken = default);
