...
public interface IProjectManagementTaskService
{
    ...
    Task<ProjectManagementTaskDetailResponse> ChangeStatusAsync(string id, ProjectManagementTaskStatusChangeRequest request, CancellationToken cancellationToken = default);
    Task<ProjectManagementTaskDependencyForceStartResponse> ForceStartAsync(string id, ProjectManagementTaskDependencyForceStartRequest request, CancellationToken cancellationToken = default);
