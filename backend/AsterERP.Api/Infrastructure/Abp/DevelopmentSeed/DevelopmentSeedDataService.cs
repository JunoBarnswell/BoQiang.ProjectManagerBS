    ...
    IOptions<DevelopmentSeedOptions> options) : IDevelopmentSeedService
{
    ...
    private void SeedMenus()
    {
        ...
        UpsertMenu("project-management", "项目管理", "platform", "/project-management", "ProjectManagementPage", "Menu", 6, true, PermissionCodes.ProjectManagementProjectView, "KanbanSquare");
