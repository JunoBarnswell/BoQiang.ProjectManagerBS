...
public class JobRetryCmd : ICommand<object?>
{
    ...
    public JobRetryCmd(string jobId, string? exceptionMessage)
    {
    ...
    public async Task<object?> ExecuteAsync(ICommandContext context, CancellationToken cancellationToken = default)
    {
        ...
        JobCommandEvents.DispatchEntityEvent(context, WorkflowEventType.JOB_RETRIES_DECREMENTED, new { JobId = _jobId, ExceptionMessage = _exceptionMessage });
        return null;
    }
}
