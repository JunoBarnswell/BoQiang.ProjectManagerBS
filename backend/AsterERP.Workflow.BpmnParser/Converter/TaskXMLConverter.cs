...
{
    public override Type GetBpmnElementType() => typeof(BpmnModelNs.SimpleTask);
    public override string GetXMLElementName() => "task";
    protected override BpmnModelNs.BaseElement ConvertXMLToElement(XmlNode xmlNode, BpmnModelNs.BpmnModel model) => new BpmnModelNs.SimpleTask();
