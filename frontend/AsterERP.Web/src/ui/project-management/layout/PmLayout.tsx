...
export const PmContent = styled(Box)({ position: 'relative', display: 'flex', flex: '1 1 auto', width: '100%', minWidth: 0, minHeight: 0, overflow: 'hidden' });
export const PmWorkbenchBody = styled(Box)({ display: 'flex', flex: '1 1 auto', width: '100%', minWidth: 0, minHeight: 0, overflow: 'hidden' });
