...
export const projectManagementWorkbenchMessagesEnUS = {
  ...
  ,'projectManagement.workbench.selector.emptyHint': 'Create something to track and let the app remember its schedule and progress.'
  ,'projectManagement.workbench.countdown.noDueDate': 'No due date'
  ,'projectManagement.workbench.countdown.completed': 'Completed'
  ,'projectManagement.workbench.countdown.overdue': '{value} days overdue'
  ,'projectManagement.workbench.countdown.hours': '{value} hours remaining'
  ,'projectManagement.workbench.countdown.days': '{value} days remaining'
  ,'projectManagement.workbench.overview.progress': 'Project progress'
  ,'projectManagement.workbench.overview.owner': 'Owner'
  ,'projectManagement.workbench.overview.schedule': 'Schedule'
  ,'projectManagement.workbench.overview.addUpdate': 'Record progress'
  ,'projectManagement.workbench.overview.exportMarkdown': 'Export Markdown'
  ,'projectManagement.workbench.overview.exportDialogTitle': 'Export Markdown report'
  ,'projectManagement.workbench.overview.exportIncludeProjectInfo': 'Include project information'
  ,'projectManagement.workbench.overview.exportSelectAll': 'Select all tasks'
  ,'projectManagement.workbench.overview.exportSelectedCount': '{selected}/{total} selected'
  ,'projectManagement.workbench.overview.exportTasksLoading': 'Loading tasks…'
  ,'projectManagement.workbench.overview.exportTasksEmpty': 'No exportable tasks in this project'
  ,'projectManagement.workbench.overview.exportSuccess': 'Markdown report downloaded'
  ,'projectManagement.workbench.overview.exportFailed': 'Could not export the Markdown report. Try again.'
  ,'projectManagement.workbench.overview.timeline': 'Progress timeline'
  ,'projectManagement.workbench.overview.loadMore': 'Load more'
  ,'projectManagement.workbench.overview.timelineEmpty': 'Record each update here once the project starts.'
