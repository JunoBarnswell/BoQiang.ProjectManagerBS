...
function readCategory(value: string | null): ProjectManagementMyWorkCategory {
  return categories.some((category) => category.value === value) ? value as ProjectManagementMyWorkCategory : 'all';
}
function readPage(value: string | null) { return Math.max(1, Number(value) || 1); }
